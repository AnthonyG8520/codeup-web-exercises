...
switch (randomColor){
    ...
    case "blue":
        ...
        break;
    case "indigo":
        console.log("Kind of purple.");
        break;
    case "violet":
        console.log("Another kind of purple.");
        break;
    default:
 ...
 */
//let userColor = prompt("Type in A color.", "");
...
//let userTotal = prompt ("Enter your total.", "");
...
function plus100(x) {
     let result = (x + 100)
         return ("That number plus 100 is " + result);
}
...
function notANumber(x){
     if (isNaN(x)){
         return ("Your input is the wrong data type.");
     }
}
